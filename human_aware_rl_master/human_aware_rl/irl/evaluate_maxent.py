...
def _loadEnvironment(config, env_setup_actions=None):
    ...
    env = ae.env
    if env_setup_actions:
        for action in env_setup_actions:
            env.run_setup_step(env_setup_actions)
    return env
...
if __name__ == "__main__":
    ...
    env = _loadEnvironment(config, joint_action)
